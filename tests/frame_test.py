import sys
# Add the parent directory containing the framework folder
sys.path.append('/home/letziou/5year/tese')

# Then import
from itc2007_framework import Exam, Period, Room

from itc2007_framework import Exam, Period, Room, Booking, ExamTimetablingProblem, ExamTimetablingSolution, Solution
